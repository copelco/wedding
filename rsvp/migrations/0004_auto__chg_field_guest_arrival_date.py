...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rsvp_guest', 'arrival_date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        'rsvp.guest': {
            ...
            'arrival_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
